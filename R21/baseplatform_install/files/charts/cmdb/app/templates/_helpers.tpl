...
{{/* Start of custom chart file: mysql service name. */}}
{{- define "mysql.service" -}}
{{- default (printf "%s-mysql" (include "cmdb.fullname" .)) .Values.services.mysql.name -}}
{{- end -}}
{{/* End of custom chart file: mysql service name. */}}
