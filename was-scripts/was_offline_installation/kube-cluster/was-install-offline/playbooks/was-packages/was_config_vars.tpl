...
# The release name prefix for Helm charts and other Kubernetes entities
# installed by the app
APP_RELEASE_NAME_PREFIX: "nwas-"
...
# For extra certificates, make sure set this tag to true and place all certificate files 
# (certificates must be in PEM format, with .pem extension) in the directory server-extra-ssl-certs.
# This directory must be in the app's release directory where the script helm-install.sh located.
# true | false
...
SUPPORT_CODEPLOYMENT: false

NETGUARD_FRAMEWORK_SECRET: {{ uuidv4 }}
NETGUARD_WAS_SECRET: {{ uuidv4 }}

NOSDBPASSWORD: {{ genPwd 14 20 0 0 0 0 "@%^" }}
WASDBPASSWORD: {{ genPwd 14 20 0 0 0 0 "@%^" }}
CKEYLISTENERCRMQPASSWORD: {{ genPwd 14 20 0 0 0 0 "@%^" }}
BPASUSERCRMQPASSWORD: {{ genPwd 14 20 0 0 0 0 "@%^" }}
